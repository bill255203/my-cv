...
def resume_view(request):
    cv = {
        ...
        "summary": (
            "I am a backend engineer who enjoys building reliable systems that people use every day. "
            "I started with quality assurance, then moved into data engineering and backend development. "
            "Along the way, I worked on financial trading systems, cloud data pipelines, and personal projects "
            "that explore AI and compliance. I believe in writing clear, maintainable code and in learning from every project."
        ),
        "skills": [
